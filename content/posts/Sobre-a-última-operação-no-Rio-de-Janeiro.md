+++
title = "Sobre a última operação no Rio de Janeiro"
description = ""
date = "2025-10-29"
updated = "2025-10-29"
draft = false
...
[taxonomies]
categories = ["Misc"]
tags = ["operação", "policia", "rj", "rio-de-janeiro"]
...
Há 40 anos, a estratégia é a mesma: confronto, ocupação temporária e um saldo de mortos. A pergunta objetiva é: funcionou? 

O Rio de Janeiro está mais seguro hoje do que há 20 anos? O poder das facções diminuiu? 
...
A "Guerra às Drogas" é o modelo de negócio do tráfico. Acabar com ela não significa "liberar geral", mas sim tirar o poder e o monopólio das mãos do criminoso e trazer para o controle do Estado. 
